...
class Addressview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => AddressCubit(AddressServices(dio: Dio()))..getAddresses(),
      child: Scaffold(
        appBar: AppBar(
          title: Text("address".tr(), style: AppStyle.titleApp),
          centerTitle: true,
        ),
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              const Divider(),
              SizedBox(height: 8.h),
              Text("saved_address".tr(), style: AppStyle.black24w600),
